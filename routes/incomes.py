...
def get_incomes(search: str = None, status: bool = True, id: int = 0,trade_id:int = 0,customer_id:int = 0,  start_date=datetime.datetime.min.date(),end_date=datetime.datetime.max.date(),page: int = 1, limit: int = 25,
    ...
    if id :
        ...
        return all_incomes(search=search,status=status,trade_id=trade_id,  page=page, limit=limit,
